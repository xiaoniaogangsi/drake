...
the sum.)""";
        ...
        // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets
        struct /* MultiAgentGraphOfConvexSets */ {
...
very large or infinite graphs, by deriving from
ImplicitGraphOfConvexSets.)""";
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::AddEdge
          struct /* AddEdge */ {
            // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
            const char* doc =
R"""(Adds an edge to the graph from Vertex ``u`` to Vertex ``v``. The
...
Raises:
    ...
    graph.)""";
          ...
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::AddEdgeFromTemplate
          struct /* AddEdgeFromTemplate */ {
            // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
            const char* doc =
R"""(Adds an edge to the graph from Vertex ``u`` to Vertex ``v`` (and
...
Raises:
    ...
    support once it's needed.)""";
          ...
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::AddVertex
          struct /* AddVertex */ {
            // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
...
concatenated in a vector.)""";
          ...
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::AddVertexFromTemplate
          struct /* AddVertexFromTemplate */ {
            // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
            const char* doc =
R"""(Adds a new vertex to the graph (and assigns a new unique VertexId) by
...
Vertex from another GCS instance into ``this``.)""";
          ...
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::ClearAllPhiConstraints
          struct /* ClearAllPhiConstraints */ {
            // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
            const char* doc =
R"""(Removes all constraints added to any edge with
AddPhiConstraintForAgent.)""";
          } ClearAllPhiConstraints;
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Clone
          struct /* Clone */ {
            // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
            const char* doc =
R"""(Returns a deep copy of this graph.
...
Raises:
    ...
    support once it's needed.)""";
          ...
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Edge
          struct /* Edge */ {
            // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
            const char* doc =
R"""(An edge in the graph connects between vertex ``u`` and vertex ``v``.
The edge also holds a list of cost and constraints associated with the
continuous variables.)""";
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Edge::AddConstraintForAgent
...
Raises:
    RuntimeError if no transcription is specified.)""";
            ...
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Edge::AddCostForAgent
            struct /* AddCostForAgent */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc_expression =
R"""(Adds a cost to this edge for agent ``agent``, described by a
symbolic::Expression ``e`` containing *only* elements of xu() and xv()
as variables. For technical reasons relating to being able to
"turn-off" the cost on inactive edges, all costs are eventually
implemented with a slack variable and a constraint:
...
Raises:
    RuntimeError if no transcription is specified.)""";
            ...
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Edge::AddPhiConstraintForAgent
...
Note:
    ...
    modifications to its bounds (i.e. requiring phi == 0.5).)""";
            ...
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Edge::ClearPhiConstraintsForAgent
...
AddPhiConstraintForAgent.)""";
            ...
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Edge::ClearPhiConstraintsForAllAgents
...
AddPhiConstraintForAgent at once)""";
            ...
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Edge::Edge
            struct /* ctor */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc = R"""()""";
            } ctor;
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Edge::GetConstraints
            struct /* GetConstraints */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc =
...
Raises:
    RuntimeError if no transcription is specified.)""";
            ...
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Edge::GetConstraintsForAgent
...
Raises:
    RuntimeError if no transcription is specified.)""";
            ...
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Edge::GetCosts
            struct /* GetCosts */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc =
...
Raises:
    RuntimeError if no transcription is specified.)""";
            ...
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Edge::GetCostsForAgent
...
Raises:
    RuntimeError if no transcription is specified.)""";
            ...
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Edge::GetSolutionCostForAgent
...
Raises:
    RuntimeError if cost is not associated with this edge.)""";
            ...
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Edge::GetSolutionCostForAllAgents
...
Raises:
    ...
    agents.)""";
            ...
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Edge::GetSolutionPhiXuForAgent
...
value of the edge slacks for all non-zero-flow edges.)""";
            ...
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Edge::GetSolutionPhiXvForAgent
...
this edge is available. See GetSolutionPhiXu() for more details.)""";
            ...
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Edge::NewSlackVariables
            struct /* NewSlackVariables */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc =
...
constraints.)""";
            ...
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Edge::id
            struct /* id */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc =
R"""(Returns the unique identifier associated with this Edge.)""";
            } id;
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Edge::n_agents
            struct /* n_agents */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc =
R"""(Returns the number of agents for this edge.)""";
            } n_agents;
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Edge::name
            struct /* name */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc =
R"""(Returns the string name associated with this edge.)""";
            } name;
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Edge::phi
            struct /* phi */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc =
...
GetSolution(phi()) on a returned MathematicalProgramResult.)""";
            ...
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Edge::u
            struct /* u */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc_0args_const =
R"""(Returns a const reference to the "left" Vertex that this edge connects
...
connects to.)""";
            ...
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Edge::v
            struct /* v */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc_0args_const =
R"""(Returns a const reference to the "right" Vertex that this edge
...
connects to.)""";
            ...
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Edge::xu
            struct /* xu */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc =
R"""(Returns the continuous decision variables associated with vertex
...
not be what you want.)""";
            ...
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Edge::xv
            struct /* xv */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc =
R"""(Returns the continuous decision variables associated with vertex
...
not be what you want.)""";
          ...
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::EdgeId
          struct /* EdgeId */ {
            // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
            const char* doc = R"""()""";
          } EdgeId;
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Edges
          struct /* Edges */ {
            // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
            const char* doc =
R"""(Returns mutable pointers to the edges stored in the graph.)""";
          } Edges;
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::GetEdgeByName
          struct /* GetEdgeByName */ {
            // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
            const char* doc =
R"""(Returns the first edge (by the order added to ``this``) with the given
name, or nullptr if no such edge exists.)""";
          ...
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::GetGraphvizStringForAgent
...
Parameter ``agent``:
    the index of agent that you want to visualize. By default,
    ``agent`` = -1, which indicates showing the sum of flows and costs
    (,etc.) of all agents.
...
Parameter ``active_path``:
    ...
    original graph edges.)""";
          ...
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::GetMutableEdgeByName
          struct /* GetMutableEdgeByName */ {
            // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
            const char* doc =
R"""(Returns the first edge (by the order added to ``this``) with the given
name, or nullptr if no such edge exists.)""";
          ...
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::GetMutableVertexByName
          struct /* GetMutableVertexByName */ {
            // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
            const char* doc =
R"""(Returns the first vertex (by the order added to ``this``) with the
given name, or nullptr if no such vertex exists.)""";
          ...
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::GetSolutionPathForAgent
...
Raises:
    ...
    ``target`` can be found in the solution.)""";
          ...
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::GetVertexByName
          struct /* GetVertexByName */ {
            // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
            const char* doc =
R"""(Returns the first vertex (by the order added to ``this``) with the
given name, or nullptr if no such vertex exists.)""";
          ...
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::IsValid
          struct /* IsValid */ {
            // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
            const char* doc_vertex =
R"""(Returns true iff ``v`` is registered as a vertex with ``this``.)""";
...
R"""(Returns true iff ``e`` is registered as an edge with ``this``.)""";
          ...
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::MultiAgentGraphOfConvexSets
          struct /* ctor */ {
            // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
            const char* doc = R"""(Constructs an empty graph.)""";
          } ctor;
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::RemoveEdge
          struct /* RemoveEdge */ {
            // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
            const char* doc =
R"""(Removes edge ``edge`` from the graph.
...
Precondition:
    The edge must be part of the graph.)""";
          ...
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::RemoveVertex
          struct /* RemoveVertex */ {
            // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
            const char* doc =
R"""(Removes vertex ``vertex`` from the graph as well as any edges from or
...
Precondition:
    The vertex must be part of the graph.)""";
          ...
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::SamplePaths
          struct /* SamplePaths */ {
            // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
            const char* doc_flows =
R"""(Samples a collection of unique paths from ``source`` to ``target``,
...
Raises:
    RuntimeError if options.max_rounded_path < 1.)""";
          ...
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::SamplePathsForAgent
...
Raises:
    RuntimeError if options.max_rounded_path < 1.)""";
          ...
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::SolveConvexRestrictionForAgent
...
GraphOfConvexSets::SolveConvexRestriction, with the agent specified by
the parameter ``agent_id`` and the number of agents specified by
``n_agents``.)""";
          } SolveConvexRestrictionForAgent;
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::SolveShortestPathForMultiAgent
...
Raises:
    ...
    continuous variables.)""";
          ...
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Transcription
          struct /* Transcription */ {
            // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
            const char* doc =
R"""(Specify the transcription of the optimization problem to which a
constraint or cost should be added, or from which they should be
retrieved.)""";
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Transcription::kMIP
            struct /* kMIP */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc =
R"""(The mixed integer formulation of the GCS problem.)""";
            } kMIP;
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Transcription::kRelaxation
            struct /* kRelaxation */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc = R"""(The relaxation of the GCS problem.)""";
            } kRelaxation;
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Transcription::kRestriction
            struct /* kRestriction */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc =
R"""(The restrction of the GCS problem where the path is fixed.)""";
          ...
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Vertex
          struct /* Vertex */ {
            // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
            const char* doc =
R"""(Each vertex in the graph has a corresponding ConvexSet, and a
std::string name.)""";
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Vertex::AddConstraint
            struct /* AddConstraint */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc_formula =
R"""(Adds a constraint to this vertex.
...
Raises:
    RuntimeError if no transcription is specified.)""";
            ...
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Vertex::AddCost
            struct /* AddCost */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc_expression =
R"""(Adds a cost to this vertex, described by a symbolic::Expression ``e``
...
Raises:
    RuntimeError if no transcription is specified.)""";
            ...
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Vertex::GetConstraints
            struct /* GetConstraints */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc =
R"""(Returns constraints on this vertex.
...
Raises:
    RuntimeError if no transcription is specified.)""";
            ...
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Vertex::GetCosts
            struct /* GetCosts */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc =
R"""(Returns costs on this vertex.
...
Raises:
    RuntimeError if no transcription is specified.)""";
            ...
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Vertex::GetSolution
            struct /* GetSolution */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc =
R"""(Returns the solution of x() in ``result``, or std::nullopt if no
...
vertex is deactivated (e.g. not in the shorest path) in the solution.)""";
            ...
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Vertex::GetSolutionCost
            struct /* GetSolutionCost */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc_1args =
R"""(Returns the sum of the costs associated with this vertex in
...
Raises:
    RuntimeError if cost is not associated with this vertex.)""";
            ...
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Vertex::Vertex
            struct /* ctor */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc = R"""()""";
            } ctor;
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Vertex::ambient_dimension
            struct /* ambient_dimension */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc =
R"""(Returns the ambient dimension of the ConvexSet.)""";
            } ambient_dimension;
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Vertex::full_dimension
...
n_agents*ambient_dimension)""";
            ...
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Vertex::id
            struct /* id */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc =
R"""(Returns the unique identifier associated with this Vertex.)""";
            } id;
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Vertex::incoming_edges
            struct /* incoming_edges */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc = R"""()""";
            } incoming_edges;
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Vertex::n_agents
            struct /* n_agents */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc =
R"""(Returns the number of agents of this GCS.)""";
            } n_agents;
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Vertex::name
            struct /* name */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc = R"""(Returns the name of the vertex.)""";
            } name;
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Vertex::outgoing_edges
            struct /* outgoing_edges */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc = R"""()""";
            } outgoing_edges;
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Vertex::set
            struct /* set */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc =
R"""(Returns a const reference to the underlying ConvexSet.)""";
            } set;
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Vertex::x
            struct /* x */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc =
R"""(Returns a decision variable corresponding to an element of the
...
costs and constraints.)""";
            ...
            // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Vertex::x_at
            struct /* x_at */ {
              // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
              const char* doc =
R"""(Returns the variable component with index ``idx`` for agent ``agent``
.)""";
            } x_at;
          } Vertex;
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::VertexId
          struct /* VertexId */ {
            // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
            const char* doc = R"""()""";
          } VertexId;
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::Vertices
          struct /* Vertices */ {
            // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
            const char* doc =
R"""(Returns mutable pointers to the vertices stored in the graph.)""";
          } Vertices;
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::num_agents
          struct /* num_agents */ {
            // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
            const char* doc = R"""()""";
          } num_agents;
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::num_edges
          struct /* num_edges */ {
            // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
            const char* doc = R"""()""";
          } num_edges;
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::num_vertices
          struct /* num_vertices */ {
            // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
            const char* doc = R"""()""";
          } num_vertices;
          // Symbol: drake::geometry::optimization::MultiAgentGraphOfConvexSets::set_num_agents
          struct /* set_num_agents */ {
            // Source: drake/geometry/optimization/multi_agent_graph_of_convex_sets.h
            const char* doc = R"""()""";
          } set_num_agents;
